...
0. 게임 종료
*/
MainMenuSelectionType Menu::PrintMainMenu()
{
    cout << "=== 메인 메뉴 ===" << endl;
    cout << "1. 던전 입장" << endl;
    cout << "2. 인벤토리 확인" << endl;
    ...
    while (true)
    {
        ...
        switch (choice)
        {
            case 0: return MainMenuSelectionType::ExitGame;
            case 1: return MainMenuSelectionType::EnterDungeon;
            case 2: return MainMenuSelectionType::PrintInventory;
            case 3: return MainMenuSelectionType::PotionShop;
            default:
                cout << "잘못된 선택입니다. 다시 선택해주세요." << endl;
                break;
        }
